...
export const PORTFOLIOS: Portfolio[] = [
  {
    ...
    description: {
      ...
      'zh-CN':
        '一个帮助游戏开发者更快打造出优秀游戏的 SaaS 平台。杭星辰很自豪地领导着产品开发和所有设计工作，以确保 Live Aware 达到最出色的水准。',
    },
    timeframe: {
      en: '2021 - now',
      'zh-CN': '2021 - 至今',
...

  {
    ...
    description: {
      ...
      'zh-CN':
        'very very spaceship 是西雅图的一家游戏开发公司，杭星辰负责开发与迭代更新他们的官网，同时帮助了他们进行官网的数字转型与优化了~10倍以上的访问速度与性能指标。',
    },
    timeframe: {
      en: '2020 - 2023',
      'zh-CN': '2020 - 2023',
...

  {
    ...
    description: {
      ...
      'zh-CN':
        'Downwordly 是一个由 Bird Cartel 开发的英语拼词游戏，你需要充分利用手中的字母去拼凑成词汇，杭星辰负责帮助 Bird Cartel 打造开发了一个 3D 版官方网站。',
    },
    timeframe: {
      en: '2021',
      'zh-CN': '2021',
